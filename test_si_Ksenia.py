...
with open("//vdspc/Share2/NL1410/test_Ksenia.txt", "a") as file1, open("C:/test/test.txt", "a") as file2:
    file1.write("\n" + "Ксения_test: " + user_input)
    file2.write("\n" + "Ксения_test: " + user_input)

print(colorama.Fore.GREEN + "Серийный номер сохранён в test.txt и test_Ksenia.txt.")
